...
#include "../include/olm/session.hh"
#include "../include/olm/account.hh"
#include "../include/olm/cipher.h"
#include "../include/olm/pickle_encoding.h"
#include "../include/olm/utility.hh"
#include "../include/olm/base64.hh"
#include "../include/olm/memory.hh"
...
__declspec(dllexport) size_t olm_error() {
    return std::size_t(-1);
}
